...
export default function ActivatePromoCodeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>როგორ გავააქტიუროთ პრომო კოდი</Text>

        <Text style={styles.description}>
          პრომო კოდის გასააქტიურებლად:
        </Text>

        <View style={styles.bulletList}>
          <Text style={styles.bulletItem}>• გახსენით თქვენი პროფილი greengo-ის აპლიკაციაში</Text>
          <Text style={styles.bulletItem}>• დააჭირეთ პრომო კოდებს</Text>
          <Text style={styles.bulletItem}>• აკრიფეთ თქვენი პრომო კოდი და დაადასტურეთ.</Text>
        </View>

        <Text style={styles.description}>
          თუ პრობლემა შეგექმნებათ პრომო კოდთან დაკავშირებით, გადაუღეთ ეკრანს ფოტო და დაუკავშირდით ჩვენს დახმარების გუნდს.
        </Text>
