...
export default function QuestionAboutMenuScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>მენიუსთან დაკავშირებით მაქვს კითხვა</Text>

        <Text style={styles.description}>
          პარტნიორი რესტორნები გვაწვდიან შემდეგ ინფორმაციას:
        </Text>

        <View style={styles.bulletList}>
          <Text style={styles.bulletItem}>• სამუშაო საათები</Text>
          <Text style={styles.bulletItem}>• პროდუქციის დასახელება</Text>
          <Text style={styles.bulletItem}>• პროდუქციის აღწერა</Text>
          <Text style={styles.bulletItem}>• პროდუქციის ხელმისაწვდომობა</Text>
          <Text style={styles.bulletItem}>• ინფორმაცია პროდუქციის ფასების შესახებ</Text>
        </View>

        <Text style={styles.description}>
          შეკითხვების არსებობის შემთხვევაში, გთხოვთ დაუკავშირდეთ მხარდაჭერის გუნდს დახმარებისთვის.
        </Text>
