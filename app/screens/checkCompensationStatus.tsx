...
export default function CheckCompensationStatusScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>მინდა ჩემი კომპენსაციის სტატუსის შემოწმება</Text>

        <Text style={styles.description}>
          თუ თქვენ გაქვთ კომპენსაციის მოთხოვნა, გთხოვთ დაუკავშირდეთ ჩვენს მხარდაჭერის გუნდს თქვენი დადასტურებული ელ.ფოსტის მისამართიდან.
        </Text>

        <Text style={styles.description}>
          გთხოვთ, მიუთითოთ თქვენი კომპენსაციის მოთხოვნის ნომერი ან შეკვეთის ნომერი, რომელთანაც ის დაკავშირებულია, რათა ჩვენ შევძლოთ სტატუსის შემოწმება.
        </Text>
