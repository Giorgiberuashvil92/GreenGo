...
export default function AboutCardPaymentScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>ბარათით ანგარიშსწორების შესახებ</Text>

        <Text style={styles.description}>
          greengo-ის აპლიკაციაში შეგიძლიათ გადაიხადოთ შეკვეთები საბანკო ბარათით. გადახდა ხდება უსაფრთხოდ, ჩვენი დაცული გადახდის სისტემის მეშვეობით.
        </Text>

        <Text style={styles.description}>
          თუ გადახდისას პრობლემა შეგექმნათ, გთხოვთ დაუკავშირდეთ ჩვენს მხარდაჭერის გუნდს თქვენი დადასტურებული ელ.ფოსტის მისამართიდან.
        </Text>
