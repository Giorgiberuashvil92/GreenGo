    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>
          შეკვეთა მხოლოდ ვოლტის აპლიკაციით (ნახავთ store-ში) ან ვებ გვერდის მეშვეობით არის შესაძლებელი. 💙
        </Text>

        <Text style={styles.description}>
          გადადით თქვენს პროფილზე და დაამატეთ თქვენი მისამართი, ასევე სასურველი გადახდის მეთოდი.
        </Text>

        <Text style={styles.description}>
          ჩაწერეთ თქვენი მისამართი შესაბამის ველში და რესტორნების (restaurants) ან მაღაზიების (stores) გვერდზე იხილავთ ობიექტებს, რომლებიც მოგემსახურებიან 😊 🚀
        </Text>
