  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>შეკვეთის განთავსება{"\n"}სხვისთვის/სხვა მისამართზე</Text>
        <Text style={styles.description}>
          შეკვეთის განთავსებისას შეგიძლიათ შეიყვანოთ ნებისმიერი მისამართი, სადაც გსურთ მიწოდება.
        </Text>
