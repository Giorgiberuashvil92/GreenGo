...
export default function AboutPromotionsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>აქციების შესახებ</Text>

        <Text style={styles.description}>
          greengo-ის აპლიკაციაში რეგულარულად ვატარებთ სხვადასხვა აქციებს და სპეციალურ შეთავაზებებს. აქციების შესახებ ინფორმაცია ხელმისაწვდომია აპლიკაციის მთავარ გვერდზე.
        </Text>

        <Text style={styles.description}>
          პრომო კოდების გასააქტიურებლად გადადით პროფილის გვერდზე და აირჩიეთ "პრომო კოდები" განყოფილება.
        </Text>
